...
export default function PurchaseOrders() {
  ...
  const tableData = filteredPo.map((po) => {
    ...
    return {
      ...
      expected_delivery: po.expected_delivery_date ? new Date(po.expected_delivery_date).toLocaleDateString() : '—',
      delivered_date: po.delivered_date ? new Date(po.delivered_date).toLocaleDateString() : '—',
