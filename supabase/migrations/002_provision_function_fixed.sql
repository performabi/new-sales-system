...
-- Creates a complete isolated schema for a new
-- company with all 18 business tables + RLS
-- =============================================
...
BEGIN
  ...
  v_schema    := 'tenant_' || replace(v_tenant_id::text, '-', '');
  ...
  -- Wire up the FK on users.assigned_store_id
  EXECUTE format('
    ALTER TABLE %I.users
  ...
  -- =============================================
  EXECUTE format('
    CREATE TABLE %I.plu_scheduled_changes (
      id              UUID          PRIMARY KEY DEFAULT gen_random_uuid(),
  ...
  -- =============================================
  EXECUTE format('
    CREATE TABLE %I.staff_timesheets (
  ...
  -- =============================================
  EXECUTE format('
    CREATE TABLE %I.store_checklists (
  ...
  -- =============================================
  EXECUTE format('
    CREATE TABLE %I.system_settings (
  ...
  -- =============================================
  EXECUTE format('
    CREATE TABLE %I.loyalty_notifications (
